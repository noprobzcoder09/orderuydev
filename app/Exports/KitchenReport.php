...
class KitchenReport extends BaseReports implements FromView, ReportsInterface
{	 
...
//        $withPaid = $this->applyCriteria($model,new WithPaid);
//        $withBilling = $this->applyCriteria($model,new WithBillingIssue);
        
//        if (!empty($model)) {
//            foreach ($model as $key => $data) {
//                $model[$key]->paid = $withPaid[$data->id];
//                $model[$key]->billing_issue = $withBilling[$data->id];
//            }
//        }
