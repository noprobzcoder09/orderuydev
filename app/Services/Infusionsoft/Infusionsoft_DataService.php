...
use App\Services\Infusionsoft\Infusionsoft_DataServiceBase;
...
class Infusionsoft_DataService extends Infusionsoft_DataServiceBase
{
    ...
    public static function addCustomField(&$object, $displayName, $dataType, $groupId, Infusionsoft_App $app = null)
    {
    ...
    public static function delete(&$object, $id, Infusionsoft_App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app, $object);
    ...
    */
    ...
    public static function load(&$object, $id, $returnFields = false, Infusionsoft_App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app, $object);
    ...
    public static function save(&$object, Infusionsoft_App $app = null)
    {
        $app = parent::getObjectOrDefaultAppIfNull($app, $object);
        $out = 0;
