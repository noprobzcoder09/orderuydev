...
use App\Services\Infusionsoft\Generated\Infusionsoft_Generated_OrderItem;
...
class Infusionsoft_OrderItem extends Infusionsoft_Generated_OrderItem{
    ...
    public function save($app = null){
        ...
        if($this->Id == ''){
            ...
            $newestOrderItems = Infusionsoft_DataService::queryWithOrderBy(new Infusionsoft_OrderItem(), array('OrderId' => $this->OrderId), 'Id', false, 1,0, false, $app);
