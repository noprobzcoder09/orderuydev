...
return [
    ...
    */
    ...
    'aliases' => [
        ...
        'Configurations'   => App\Models\Configurations::class,
        'Excel' => Maatwebsite\Excel\Facades\Excel::class,
        'Zipper' => Chumper\Zipper\Zipper::class,
        'Helper' => App\Services\Helper::class,
        'UsersRepository' => App\Services\UsersRepository::class,
        'CustomFields' => App\Services\InfusionsoftV2\CustomField::class,
