var Card = function() {
    ...
    function loadCards() {
        ...
        System.lazyLoading( function() {
            System.setAjaxRequest(
                ...
                function() {
                    System.unblockUI();
                    cardForm.html("Failed to retrieve cards. Try to <a onclick='Card.loadCards()' href='javascript::'>Reload.</a>");
                }, 'json', true
            );
        });
    }

    function isValidCreditCardDetails() {
    ...
    return {
        ...
        isValidCreditCardDetails: isValidCreditCardDetails,
        loadCards: loadCards,
        bindCreditCards: bindCreditCards,
        isCheckedNewCard: isCheckedNewCard,
        getCardId: getCardId,
    }
}();