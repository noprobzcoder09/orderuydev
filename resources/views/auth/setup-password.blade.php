                        ...
                        <div class="card-body">
                            ...
                            <form id="login-form">
                                ...
                                <div class="input-group mb-4">
                                    ...
                                    <input type="password" name="confirm_password" id="confirm_password" required class="form-control{{ $errors->has('password') ? ' is-invalid' : '' }}" placeholder="{{ __('Confirm Password') }}">
                                </div>
                                <div class="row">
                                    <div class="col-6">
