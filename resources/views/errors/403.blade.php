    ...
    <div class="container">
        <div class="row justify-content-center">
	        ...
	        <div class="clearfix">
	          ...
	          <h4 class="pt-3">Oops! {{$exception->getMessage()}}</h4>
	          <p class="text-muted">The page you are looking for was not found/expired already.</p>
	        </div>
	        <div class="input-prepend input-group">
	            <a href="{{url('/redirectusers')}}" class="btn btn-info" type="button">Go to home page.</a>
	        </div>
	      </div>
        </div>
    </div>
