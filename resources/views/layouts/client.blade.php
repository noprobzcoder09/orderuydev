        ...
        <div id="topnav-container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <ul class="main-menu-items pull-right" id="top-links">
                        <?php $name = (new \App\Repository\UsersRepository)->getFirstName(); ?>
                        @if(!empty($name))
                        <li>Hi {{$name}},</li>
                        @endif
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-12 col-md-4 col-lg-6">
                    ...
                    <a class="navbar-brand-v2" href="{{url('/')}}"><img src="{{asset('images/logo.png')}}" width="258" height="43"/></a>
                ...
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-6">
                    <ul class="main-menu-items responsive-override">
                        ...
                        @if(Auth::check()) 
                            <li class="nav-item">
                                <a class="text-uppercase btn btn-md btn-uy-success" href="{{url('dashboard')}}" style="">Dashboard</a>
                            </li>
                        @else
                            <li class="nav-item">
                               <a class="text-uppercase btn btn-md btn-uy-success" href="{{url('login')}}">Login</a>
                            </li>
                        @endif
                    </ul>
                </div>
