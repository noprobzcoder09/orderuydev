<div class="row">
    <div class="col-md-12">
    	<div id="order-summary-wrapper" class="width-50">
			...
			<table class="" id="table-order-summary">
				<tbody>
					...
					@if(!empty($order))
						...
						<tr>
							<td class="text-indent">
								<a href="javascript:;" onclick="Checkout.removeOrder({{$key}})"><i class="fa fa-times text-danger"></i></a>
					...
					<tr>
						<td class="text-indent">
							@php($str = '')
							<a onclick="Coupons.removePrommo(this, '{{$row['code']}}')" href="javascript:;"><i class="fa fa-times text-danger"></i></a>
