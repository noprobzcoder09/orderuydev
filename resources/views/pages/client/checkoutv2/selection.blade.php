<div class="row margin-top-20">
    <div class="col-md-12">
        ...
        <form id="menu-form">
            ...
            <div class="row clearfix">
                ...
                <div class="col-md-6 text-center">
                    <div class="row clearfix">
                        <div class="col-md-12">
                            <h3>&nbsp;</h3>                 
                            @if(!empty($plan->meal_plan_image))
                                <img width="100%" src="{{url(str_replace('public','storage',$plan->meal_plan_image))}}">
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="row margin-top-20">
                <div class="col-md-12">
                    <a href="javascript:;" class="btn btn-lg btn-ecommerce btn-addtocart">Add to cart</a>
                </div>
            </div>
        </form>
    </div>
