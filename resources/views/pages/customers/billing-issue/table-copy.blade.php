           ...
           <td>
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" aria-labelledby="groupbuttonadvance-'.$row->subscriptions_cycle_id.'">
                        ...
                        <a href="javascript:;" class="m-btn dropdown-item" onclick="BillingIssue.showCardModal({{$row->user_id}},{{$row->id}})">Update Card</a>
                        <a href="javascript:;" class="m-btn dropdown-item" onclick="BillingIssue.billNow(this, {{$row->user_id}})">Bill Now</a>
                        <a href="javascript:;" class="m-btn dropdown-item" onclick="BillingIssue.cancelForTheWeek(this, {{$row->user_id}},{{$row->subscription_cycle_ids}})">Cancel For Week Only</a>
                        <a href="javascript:;" class="m-btn dropdown-item" onclick="BillingIssue.cancelCustomer(this, {{$row->user_id}})">Cancel Customer</a>
                    </div>
                </div>
           </td>
        </tr>
